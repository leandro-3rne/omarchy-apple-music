...
// Visually identical to Omarchy's PanelSlider. This plugin-local variant
// only reverses the wheel delta because scrolling a playback timeline should
// move in the direction requested by this plugin: down advances, up rewinds.
Item {
  id: root
